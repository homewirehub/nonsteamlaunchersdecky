          ...
          window.SP_REACT.createElement(deckyFrontendLib.ConfirmModal, { bAllowFullSize: true, onCancel: closeModal, onEscKeypress: closeModal, strMiddleButtonText: 'Add Another Site', onMiddleButton: addSiteFields, bMiddleDisabled: !canSave, bOKDisabled: !canSave || !selectedBrowser, onOK: onSave, strOKButtonText: "Create Shortcuts", strTitle: "Enter Custom Websites" },
              window.SP_REACT.createElement(deckyFrontendLib.DialogBody, null,
                  window.SP_REACT.createElement("div", { style: { display: 'flex', flexDirection: 'row', flexWrap: 'wrap', gap: '1em', marginBottom: '1em', alignItems: 'center' } },
                      ...
                      window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: "Vivaldi", checked: selectedBrowser === "Vivaldi", onChange: () => handleBrowserSelect("Vivaldi") }),
                      window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: "LibreWolf", checked: selectedBrowser === "LibreWolf", onChange: () => handleBrowserSelect("LibreWolf") }))),
  ...
  const LauncherInstallModal = ({ closeModal, launcherOptions, serverAPI }) => {
      ...
      return ((progress.status !== '' && progress.percent < 100) ? (window.SP_REACT.createElement(deckyFrontendLib.ModalRoot, { onCancel: cancelOperation },
          ...
          window.SP_REACT.createElement(deckyFrontendLib.DialogBody, null,
              ...
              currentLaunchers.map(({ name, label }) => (window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { key: name, label: window.SP_REACT.createElement("div", { style: { display: 'flex', alignItems: 'center' } },
                      ...
                      window.SP_REACT.createElement("span", { style: {
                          ...
                          } })), checked: options.find(option => option.name === name)?.enabled ? true : false, onChange: (value) => handleToggle(name, value) }))),
      ...
      return ((progress.status !== '' && progress.percent < 100) ? (window.SP_REACT.createElement(deckyFrontendLib.ModalRoot, null,
          ...
          window.SP_REACT.createElement(deckyFrontendLib.DialogBody, null,
              window.SP_REACT.createElement("div", { style: { display: 'flex', flexDirection: 'row', flexWrap: 'wrap', gap: '1em', marginBottom: '1em', alignItems: 'center' } },
                  ...
                  window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: "Vivaldi", checked: selectedBrowser === "Vivaldi", onChange: () => setSelectedBrowser("Vivaldi") }),
                  window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: "LibreWolf", checked: selectedBrowser === "LibreWolf", onChange: () => setSelectedBrowser("LibreWolf") }))),
                  ...
                  window.SP_REACT.createElement("div", { style: { marginTop: '5px', textAlign: 'center', fontSize: "12px" } },
                      ...
                      window.SP_REACT.createElement("div", { style: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '10px' } },
                          ...
                          window.SP_REACT.createElement(deckyFrontendLib.ButtonItem, { layout: "below", onClick: () => window.open('https://github.com/sponsors/moraroy', '_blank') },
                              ...
                              "GitHub"),
                          window.SP_REACT.createElement(deckyFrontendLib.ButtonItem, { layout: "below", onClick: () => window.open('https://buymeacoffee.com/moraroy', '_blank') },
                              window.SP_REACT.createElement("img", { src: "https://www.iconpacks.net/icons/free-icons-8/free-buymeacoffee-yellow-circle-round-logotype-icon-27358.png", alt: "Buy Me A Coffee", style: { width: '20px', height: '20px', marginRight: '10px' } }),
                              "Buy Me A Coffee"),
